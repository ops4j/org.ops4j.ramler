...
public class NestedArrayTest {
    ...
    public static void shouldGenerateArrays() {
        ...
        config.setSourceFile("src/test/resources/raml/nestedArray.raml");
        config.setBasePackage("org.ops4j.raml.nestedarray");
        ...
        modelPackage = codeModel._package("org.ops4j.raml.nestedarray.model");
    }
